...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='userprofile',
            name='signature',
            field=models.TextField(default='', max_length=1024, verbose_name='Signature', blank=True),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='userprofile',
            name='signature_html',
            field=models.TextField(default='', max_length=1054, verbose_name='Signature HTML Version', blank=True),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='userprofile',
